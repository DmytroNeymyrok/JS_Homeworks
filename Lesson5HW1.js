...
// Другий спосіб з використанням while та циклів (без repeat)
...
// Другий спосіб з використанням for та циклів (без repeat)
...
/* function drawTriangle (height, symbol) {  // можна показувати
    for (let i = 1; i <= height; i++) {
        let line = '';
        for (let j = 1; j <= i; j++) {
            line += symbol;
